...
export default function StockInsiderTrading(props) {
  ...
  function prepData(json) {
    ...
    useEffect(() => {
      const url = `https://financialmodelingprep.com/api/v4/insider-trading?symbol=${props.ticker}&page=0&apikey=${financialmodelingprep.api_key}`
      const apiGet = () => {
          fetch(url)
  ...
  return (
    <Container maxWidth="xl">
      ...
      >
        ...
        <DataGrid  autoHeight rows={data} rowsPerPage={25} columns={INSIDER_COLUMNS} 
